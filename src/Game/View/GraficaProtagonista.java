...
public class GraficaProtagonista {
	...
	ArrayList <Image> sprites;  //corrente avr� al suo interno le animazioni che dovr� mostrare in quel momento 
	Image corrente;
	...
	private ArrayList<Image> getResources(String name) {
		...
		try {
			...
			for (File r : f.listFiles()) //listFiles � una funzione che ritorna un a con tutti i file relativi a quella cartella
