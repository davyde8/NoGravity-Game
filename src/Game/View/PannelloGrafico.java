...
public class PannelloGrafico extends JPanel {
	...
	public synchronized void creaMappa(String liv) {
		...
		es.submit(new ThreadGrafico(this)); // passiamo il pannello grafico
	...
	//Utilizziamo Graphics2D in quanto � preferibile visto l'uso di AffineTransfrom
	//NB: Graphics2D � un oggetto che estende Graphics, � incluso nella libreria standard di Java
